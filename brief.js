...
export function facts(widgets) {
  ...
  return widgets.map((w) => {
    ...
    switch (w.type) {
      ...
      case "garden": { const p = w.garden?.plantView; return p ? `Garden: ${p.name} ${p.wateredToday ? "watered" : "not watered yet"}, streak ${w.garden.streak} days.` : null; }
